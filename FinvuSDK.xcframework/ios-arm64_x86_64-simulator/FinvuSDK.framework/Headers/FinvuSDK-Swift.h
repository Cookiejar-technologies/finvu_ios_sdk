...
- (void)connect;
- (void)disconnect;
/// Check connection and reconnect if needed (e.g., when app returns from background)
/// Only reconnects if session is still valid (CSID exists) and not already connected
